...
[Download DisplayFill 1.0.3 for macOS](https://github.com/dashhuang/DisplayFill/releases/download/v1.0.3/DisplayFill-1.0.3-4-macOS.zip). This direct-download build is signed with Developer ID and notarized by Apple. Older builds are available on the [GitHub Releases](https://github.com/dashhuang/DisplayFill/releases) page.
