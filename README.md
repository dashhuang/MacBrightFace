...
[Download DisplayFill 1.0.6 for macOS](https://github.com/dashhuang/DisplayFill/releases/download/v1.0.6/DisplayFill-1.0.6-7-macOS.zip). Older builds are available on the [GitHub Releases](https://github.com/dashhuang/DisplayFill/releases) page.
...
[下载 DisplayFill 1.0.6 for macOS](https://github.com/dashhuang/DisplayFill/releases/download/v1.0.6/DisplayFill-1.0.6-7-macOS.zip)。旧版本可在 [GitHub Releases](https://github.com/dashhuang/DisplayFill/releases) 页面查看。
