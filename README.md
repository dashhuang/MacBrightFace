...
[Download DisplayFill 1.0.5 for macOS](https://github.com/dashhuang/DisplayFill/releases/download/v1.0.5/DisplayFill-1.0.5-6-macOS.zip). Older builds are available on the [GitHub Releases](https://github.com/dashhuang/DisplayFill/releases) page.
...
[下载 DisplayFill 1.0.5 for macOS](https://github.com/dashhuang/DisplayFill/releases/download/v1.0.5/DisplayFill-1.0.5-6-macOS.zip)。旧版本可在 [GitHub Releases](https://github.com/dashhuang/DisplayFill/releases) 页面查看。
